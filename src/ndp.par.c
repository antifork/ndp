...
#line 733 "/usr/local/share/apg/apg.db"
    case APG_EIPV4:
      	fprintf (LO_ " is designed to be a valid ipv4;\n", LO__ );
      	break;
#line 737 "/usr/local/share/apg/apg.db"
    case APG_EHOST:
      	fprintf (LO_ " is designed to be a valid host;\n", LO__ );
      	break;
...
#line 1020 "/usr/local/share/apg/apg.db"
...
#line 1034 "/usr/local/share/apg/apg.db"
    case T_HOST:
      {
	register int state;
...
#line 1417 "/usr/local/share/apg/apg.db"
...
#line 1446 "/usr/local/share/apg/apg.db"
  {
    register int i = 1;
    for (; i <= QMAX_ELEM; i++)
